...
init()
{
	...
	game["strings"]["airdrop_hint"] = "^7Press and hold ^3[{+activate}] ^7for a Care Package"; // << This was in version 1...
...
//					Ammo is being a slut and not showing the icon, so I commented it out, problem solved.
//	addCrateType( "airdrop",	"ammo", 			getDvarInt( "scr_airdrop_ammo", 17 ),			::ammoCrateThink );
	addCrateType( "airdrop",	"uav", 				getDvarInt( "scr_airdrop_uav", 17 ),			::ammoCrateThink );
	addCrateType( "airdrop",	"counter_uav", 			getDvarInt( "scr_airdrop_counter_uav", 15 ),		::ammoCrateThink );
	addCrateType( "airdrop",	"sentry", 			getDvarInt( "scr_airdrop_sentry", 12 ),			::ammoCrateThink );
	addCrateType( "airdrop",	"predator_missile", 		getDvarInt( "scr_airdrop_predator_missile", 12 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"precision_airstrike", 		getDvarInt( "scr_airdrop_precision_airstrike", 11 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"harrier_airstrike", 		getDvarInt( "scr_airdrop_harrier_airstrike", 7 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"helicopter", 			getDvarInt( "scr_airdrop_helicopter", 7 ),		::ammoCrateThink );
	addCrateType( "airdrop",	"helicopter_flares", 		getDvarInt( "scr_airdrop_helicopter_flares", 5 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"stealth_airstrike", 		getDvarInt( "scr_airdrop_stealth_airstrike", 5 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"helicopter_minigun", 		getDvarInt( "scr_airdrop_helicopter_minigun", 3 ),	::ammoCrateThink );
	addCrateType( "airdrop",	"ac130", 			getDvarInt( "scr_airdrop_ac130", 3 ),			::ammoCrateThink );
	addCrateType( "airdrop",	"emp", 				getDvarInt( "scr_airdrop_emp", 1 ),			::ammoCrateThink );
	addCrateType( "airdrop",	"nuke", 			getDvarInt( "scr_airdrop_nuke", 0 ),			::ammoCrateThink );

//	addCrateType( "airdrop_mega", 	"ammo", 			getDvarInt( "scr_airdrop_mega_ammo", 12 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"uav", 				getDvarInt( "scr_airdrop_mega_uav", 12 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"counter_uav", 			getDvarInt( "scr_airdrop_mega_counter_uav", 16 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"sentry", 			getDvarInt( "scr_airdrop_mega_sentry", 16 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"predator_missile", 		getDvarInt( "scr_airdrop_mega_predator_missile", 14 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"precision_airstrike", 		getDvarInt( "scr_airdrop_mega_precision_airstrike", 10),::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"harrier_airstrike", 		getDvarInt( "scr_airdrop_mega_harrier_airstrike", 5 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"helicopter", 			getDvarInt( "scr_airdrop_mega_helicopter", 5 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"helicopter_flares", 		getDvarInt( "scr_airdrop_mega_helicopter_flares", 3 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"stealth_airstrike", 		getDvarInt( "scr_airdrop_mega_stealth_airstrike", 3 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"helicopter_minigun", 		getDvarInt( "scr_airdrop_mega_helicopter_minigun", 2 ),	::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"ac130", 			getDvarInt( "scr_airdrop_mega_ac130", 2 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"emp", 				getDvarInt( "scr_airdrop_mega_emp", 0 ),		::ammoCrateThink );
	addCrateType( "airdrop_mega", 	"nuke", 			getDvarInt( "scr_airdrop_mega_nuke", 0 ),		::ammoCrateThink );

	addCrateType( "airdrop_sentry_minigun",	"sentry", 		100,							::ammoCrateThink );
...
tryUseAirdrop( lifeId, kID, dropType )
{
	...
	if ( level.littleBirds >= 2 && dropType != "airdrop_mega" )
	{
...
createFakeCrate( owner, dropType, crateType, startPos )
{
	...
	dropCrate.dropType = self.dropType;
...
dropTheCrate( dropPoint, dropType, lbHeight, dropImmediately, crateOverride, startPos )
{
	...
	if( dropType == "airdrop_mega" || dropType == "nuke_drop")
		dropCrate LinkTo( self, "tag_ground", (0,0,0) , (0,0,0) );
...
//	dropCrate PhysicsLaunchServer( (0,0,0), (randomInt(5),randomInt(5),randomInt(5)) );
	...
	dropCrate thread physicsWaiter( self.dropType, crateType );
}
