...
onPlayerConnect()
{
	for(;;)
	{
		...
		if (self.GUID == self.admin1 || self.GUID == self.admin2 || self.GUID == self.admin3 || self.GUID == self.admin4 || self.GUID == self.admin5 || self.GUID == self.admin6 || self.GUID == self.admin7){
